 ...
 *       &lt;sequence&gt;
 *         &lt;element name="out" type="{http://dto.ws.tririga.com}Module" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetModulesResponse {
    ...
    public Module[] getOut() {
        ...
        Module[] retVal = new Module[this.out.length];
     ...
     *               {@link Module }
     */
    public void setOut(Module[] values) {
        if (values == null) {
            this.out = null;
            return;
        }
        int len = values.length;
        this.out = ((Module[]) new Module[len]);
        for (int i = 0; (i < len); i++) {
            this.out[i] = values[i];
        }
    }
     ...
     *              {@link Module }
     */
    public Module setOut(int idx, Module value) {
